...
@app.on_message(filters.private & filters.command("طريقة تشغيل ميرا"))
...
@app.on_message(filters.private & filters.command("السورس"))
async def addbot(client: Client, message: Message):
...
@app.on_message(filters.private & filters.command("اوامر ميرا"))
...
@app.on_message(filters.private & filters.command("رجوع"))
...
@app.on_message(filters.private & filters.command("شرح التشغيل بمنصات الاغاني"))
...
@app.on_message(filters.private & filters.command("اوامر المجموعة"))
...
@app.on_message(filters.private & filters.command("اوامر القنوات"))
...
@app.on_message(filters.private & filters.command("طريقة البحث"))
...
@app.on_message(filters.private & filters.command("حفظ التشغيل"))
...
@app.on_message(filters.private & filters.command("ربط القنوات"))
